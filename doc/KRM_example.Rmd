...
library(dplyr)
#library(KRMr)
stb_fb = KRMr::stb_fb #fish body shapes of a few stickleback
stb_sb = KRMr::stb_sb #swimbladder shape of a few sticklback
```
...
TSrot = KRMr::krm.sim(frequency =c(38,200) * 1000,
                   c.w = 1490,
                   rho.w = 1030,
                   theta=65:115,
                   c.fb = 1570,
